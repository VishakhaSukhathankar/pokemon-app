        ...
        <Link to={`/pokemon/${combinePokemonDetailsData?.name}`}>
            {classIdentifier === "evolution-chain" ? (
                ...
                <CardContent>
                    ...
                    {classIdentifier === "detail-section-left" && <div className='section-left-header-wrap'>
                        <div className='height'>
                            <SvgIcon aria-label="height" sx={{ padding: 0 }}>
                                <Height sx={{ height: 38, width: 38 }} />
                            </SvgIcon>
                    ...
                    <p className='name'>{combinePokemonDetailsData?.name}</p>
                    {classIdentifier !== "detail-section-left" && <p className='description'>{pokemonDescription}</p>}
                    <Grid
                        container
                        spacing={4}
                        columns={12}
